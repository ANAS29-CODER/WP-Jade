...
class AcfViewData extends AcfCptData
{
     ...
     * @var Item[]
     * @label Fields
     * @instructions Fields of this view. Tip : hover mouse on the field number column and drag to reorder
